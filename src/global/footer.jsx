...
export default function Footer() {
  return (
    <motion.footer
      ...
      className="mt-16 w-full border-t border-neutral-300 bg-neutral-200 px-5 text-xs"
    >
      <section className="w-full">
        {/* Logo */}
        <div className="flex flex-col items-center border-t border-gray-200 pt-6 text-center">
        ...
        <div className="items center flex w-full flex-col border-t border-neutral-400 text-center">
          <div>Contact Us:</div>
          <div>
